 ...
 */ ?>
<a href="<?php the_permalink(); ?>" class="entry-card-wrap a-wrap cf recommend" title="<?php echo esc_attr(get_the_title()); ?>">
  <article id="post-<?php the_ID(); ?>" class="post-<?php the_ID(); ?> entry-card e-card cf">
    <figure class="entry-card-thumb card-thumb e-card-thumb">
      ...
      if ( has_post_thumbnail() && $thumbnail_tag ): ?>
        ...
        <?php 
        // yhei子テーマカスタマイズ。サムネイル大きく。
        the_post_thumbnail('thumb768_raw' , array('class' => 'entry-card-thumb-image card-thumb-image', 'alt' => '') ); ?>
